...
bkgr_image_filepaths, bkgr_label_filepaths, bkgr_color_filepaths, bkgr_meta_filepaths = my_modules.import_dataset_filepaths(
...
for (lbl_path, col_lbl_path, img_path, meta_path) in zip(bkgr_label_samples, bkgr_color_samples, bkgr_image_samples,
    ...
    for stemCnts, circle in zip(compactContours,circles):
        ...
        cv2.circle(stem_mask, (stem_x, stem_y), 11, 1, thickness=-1)
        #stem_mask[stem_y,stem_x] = 1
        bbox = {
            "plant_id": bboxid,
            "inserted": False,
